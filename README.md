...
[Documentation available here](https://charles-future.github.io/simple_rl/docs/index.html)
...
Alternatively, you can download simple_rl [here](https://github.com/charles-future/simple_rl/tarball/v0.811).

## Citation

If you use simple_rl in your research, please cite the [workshop paper](https://charles-future.github.io/papers/simple_rl.pdf) as follows:
...
Some examples showcasing basic functionality are included in the [examples](https://github.com/charles-future/simple_rl/tree/master/examples) directory.
...
<img src="https://charles-future.github.io/blog/posts/images/simple_grid.jpg" width="480" align="center">
...
<img src="https://charles-future.github.io/blog/posts/images/rn_grid.jpg" width="480" align="center">
...
<img src="https://charles-future.github.io/blog/posts/images/rn_grid_reproduce.jpg" width="480" align="center">

Easy! This is a new feature, so there may be bugs -- just let me know as things come up. It's only supposed to work for MDPs, not POMDPs/OOMDPs/MarkovGameMDPs (so far). Take a look at [_reproduce_example.py_](https://github.com/charles-future/simple_rl/blob/master/examples/reproduce_example.py) for a bit more detail.
...
If you'd like to contribute: that's great! Take a look at some of the needed improvements below: I'd love for folks to work on those items. Please see the [contribution guidelines](https://github.com/charles-future/simple_rl/blob/master/CONTRIBUTING.md). Email me with any questions.
